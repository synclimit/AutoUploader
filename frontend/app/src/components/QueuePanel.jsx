    ...
    <div className="flex-1 min-w-0 bg-[#101722] border border-white/[0.05] rounded-2xl overflow-hidden flex flex-col">
      ...
      <div className="h-[72px] border-b border-white/[0.04] px-4 flex items-center justify-between shrink-0">
        ...
        <div>
          ...
          <div className="text-[18px] font-bold text-[var(--accent-400)]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="h-[48px] px-5 rounded-xl bg-[var(--accent-500)]/10 border border-[var(--accent-500)]/20 text-[var(--accent-400)] text-sm font-semibold hover:bg-[var(--accent-500)]/20 transition-all">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px]">
                      ...
                      <div className="flex items-center gap-1 text-[var(--accent-400)] font-semibold">
                  ...
                  <div className="shrink-0 text-right min-w-[90px]">
                    ...
                    <div className="mt-1 text-[var(--accent-400)] font-semibold text-sm">
