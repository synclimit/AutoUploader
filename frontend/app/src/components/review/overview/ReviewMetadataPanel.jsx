        ...
        {activeTab === 'Advanced Settings' && (
           <div className="flex flex-col gap-2">
             {[
               ...
               { label: 'License', value: edits.license !== undefined ? edits.license : (video.license || 'standard'), field: 'license', options: [{val: 'standard', label: 'Standard YouTube License'}, {val: 'creativeCommon', label: 'Creative Commons'}] },
               { label: 'Visibilitas', value: edits.privacy_status !== undefined ? edits.privacy_status : (video.privacy_status || 'public'), field: 'privacy_status', options: [{val: 'public', label: 'Publik'}, {val: 'private', label: 'Pribadi'}, {val: 'unlisted', label: 'Tidak Publik'}] },
               { 
                 label: 'Bahasa video', 
                 value: edits.audio_language !== undefined ? edits.audio_language : (video.audio_language || ''), 
                 field: 'audio_language', 
                 options: [
                   {val: '', label: 'Pilih (None)'},
                   {val: 'id', label: 'Indonesian (Bahasa Indonesia)'},
                   {val: 'en', label: 'English (United States)'},
                   {val: 'en-GB', label: 'English (United Kingdom)'},
                   {val: 'ms', label: 'Malay (Bahasa Melayu)'},
                   {val: 'ar', label: 'Arabic (العربية)'},
                   {val: 'ja', label: 'Japanese (日本語)'},
                   {val: 'ko', label: 'Korean (한국어)'},
                   {val: 'zh-Hans', label: 'Chinese (Simplified)'},
                   {val: 'zh-Hant', label: 'Chinese (Traditional)'},
                   {val: 'es', label: 'Spanish (Español)'},
                   {val: 'pt', label: 'Portuguese (Português)'},
                   {val: 'pt-BR', label: 'Portuguese (Brazil)'},
                   {val: 'fr', label: 'French (Français)'},
                   {val: 'de', label: 'German (Deutsch)'},
                   {val: 'ru', label: 'Russian (Русский)'},
                   {val: 'hi', label: 'Hindi (हिन्दी)'},
                   {val: 'th', label: 'Thai (ไทย)'},
                   {val: 'vi', label: 'Vietnamese (Tiếng Việt)'},
                   {val: 'tl', label: 'Filipino / Tagalog'},
                   {val: 'tr', label: 'Turkish (Türkçe)'},
                   {val: 'it', label: 'Italian (Italiano)'},
                   {val: 'nl', label: 'Dutch (Nederlands)'},
                   {val: 'pl', label: 'Polish (Polski)'}
                 ] 
               },
               { 
                 label: 'Bahasa judul dan deskripsi', 
                 value: edits.default_language !== undefined ? edits.default_language : (video.default_language || ''), 
