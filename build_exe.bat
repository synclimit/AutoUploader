...
pyinstaller --noconfirm --onefile --name "RaynzPitStop_App" --noconsole --add-data "frontend_dist;frontend_dist" --add-data "services\license\keys\public.pem;services\license\keys" --add-data "..\client_secret.json;." --add-data "..\version.json;." --icon="../logo_baru.ico" main.py
